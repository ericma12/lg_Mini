...
import (
	...
	"fmt"
	"io/ioutil"
	"localhost/lgMini/lagouSpider/fake"
	"localhost/lgMini/lagouSpider/pkg/uuid"
	"log"
	"net/http"
	"net/url"
	"strings"
...
func (l *jobService) GetJobs(pn int, kd string) (*ListResult, error) {
	...
	req.Header.Add("Cookie", "_ga=GA1.2.161331334.1522592243; "+
		"user_trace_token=20180607084156-"+uuid.GetUUID()+"; "+
		"LGUID=20180607084156-"+uuid.GetUUID()+"; "+
		...
		"LGRID=20180607160742-"+uuid.GetUUID()+"; "+
